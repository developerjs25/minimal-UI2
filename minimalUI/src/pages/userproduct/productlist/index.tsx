import { Box, Grid, Card, CardContent, Typography, CardMedia, Chip, CircularProgress, TextField, InputAdornment, Stack, Button, } from "@mui/material";
                    ...
                    {products.map((item) => (
                        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} key={item._id}>
                            <Card sx={{
                                ...
                                {/* Product Image */}
                                <CardMedia component="img" height="240" image={`http://localhost:3003/uploads/${item.imageName}`} alt={item.productName} 
                                sx={{ objectFit: "cover", }} />
                                <CardContent>
                                    ...
                                    <Button fullWidth variant="contained" onClick={()=>{ navigate(`/user/product/details/${item._id}`) }} sx={{
