...
var SelectFocusSourceContext = React14.createContext(null);
if (true) {
  SelectFocusSourceContext.displayName = "SelectFocusSourceContext";
}
function useSelectFocusSource() {
  const context = React14.useContext(SelectFocusSourceContext);
  return context;
}
...
var SelectInput = React15.forwardRef(function SelectInput2(props, ref) {
  ...
  const [openInteractionType, setOpenInteractionType] = React15.useState(null);
  ...
  return (0, import_jsx_runtime12.jsxs)(React15.Fragment, {
    children: [(0, import_jsx_runtime12.jsx)(SelectSelect, {
      ...
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime12.jsx)(SelectFocusSourceProvider, {
      value: openInteractionType,
      children: (0, import_jsx_runtime12.jsx)(Menu_default, {
        id: `menu-${name || ""}`,
...
//# sourceMappingURL=chunk-YP4W3VSS.js.map
