...
import {
  ...
  useYAxes,
  warnOnce
} from "./chunk-NKMLBZUR.js";
import "./chunk-GMW2YPDW.js";
import "./chunk-QYWCWBY5.js";
import "./chunk-UAFRMT4N.js";
import {
  useSlotProps_default
} from "./chunk-AIBFN4YR.js";
import "./chunk-RTX5XGPT.js";
import "./chunk-4J377ZCM.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-SLXTWACX.js";
import {
  useThemeProps
} from "./chunk-FHELBYIP.js";
import "./chunk-THRVTEQ6.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-DA6N5A2T.js";
import "./chunk-MZXTZEVO.js";
import "./chunk-VNKAHKHS.js";
import "./chunk-X34AUYXR.js";
import "./chunk-CZHDTBS5.js";
import "./chunk-2SAA63IA.js";
import "./chunk-63TVYCUX.js";
import {
  useTheme
} from "./chunk-G36I4UVW.js";
import "./chunk-57NG3LHC.js";
import {
  _extends,
  composeClasses,
  ...
  styled_default,
  useId
} from "./chunk-3GX2ANDJ.js";
import {
  require_prop_types
} from "./chunk-RDYMAJYW.js";
import {
  require_jsx_runtime
...
var _excluded5 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick", "hidden"];
...
var _excluded7 = ["x", "y", "id", "classes", "color", "dataIndex", "onClick", "skipAnimation", "isFaded", "isHighlighted", "shape", "hidden"];
...
var _excluded8 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation", "isFaded", "isHighlighted", "hidden", "style"];
...
var _excluded13 = ["xAxis", "yAxis", "width", "height", "margin", "color", "baseline", "sx", "showTooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className", "disableClipping", "clipAreaOffset", "onHighlightChange", "onHighlightedAxisChange", "highlightedAxis", "highlightedItem"];
...
var SparkLineChart = React18.forwardRef(function SparkLineChart2(props, ref) {
  ...
  const id = useId();
  const clipPathId = `${id}-clip-path`;
  const clipPathOffset = React18.useMemo(() => ({
  ...
  const defaultXHighlight = React18.useMemo(() => showHighlight && plotType === "bar" ? {
    x: "band"
  } : {
    x: "none"
  }, [plotType, showHighlight]);
  const axisHighlight = React18.useMemo(() => _extends({}, defaultXHighlight, inAxisHighlight), [defaultXHighlight, inAxisHighlight]);
  const Tooltip = props.slots?.tooltip ?? ChartsTooltip;
  const colors = React18.useMemo(() => {
    if (color == null) {
      return void 0;
    }
    return typeof color === "function" ? (mode) => [color(mode)] : [color];
  }, [color]);
  const series = React18.useMemo(() => [_extends({
    type: plotType,
    data,
    valueFormatter
  }, plotType === "bar" ? {} : {
  ...
  const xAxis = React18.useMemo(() => [_extends({
    id: DEFAULT_X_AXIS_KEY,
  ...
  const yAxis = React18.useMemo(() => [_extends({
    id: DEFAULT_Y_AXIS_KEY
  }, yAxisProps, {
    position: "none"
  })], [yAxisProps]);
  return (0, import_jsx_runtime15.jsxs)(ChartDataProvider, {
    series,
    width,
    height,
    margin,
    ...
    highlightedAxis,
    highlightedItem,
    children: [(0, import_jsx_runtime15.jsxs)(ChartsSurface, _extends({
      className,
      ref,
      sx
    }, other, {
      children: [(0, import_jsx_runtime15.jsxs)("g", {
        ...
        children: [plotType === "bar" && (0, import_jsx_runtime15.jsx)(BarPlot, {
          ...
          slots,
          slotProps
        }), plotType === "line" && (0, import_jsx_runtime15.jsxs)(React18.Fragment, {
        ...
        children: [(0, import_jsx_runtime15.jsx)(LineHighlightPlot, {
          slots,
          slotProps
        }), (0, import_jsx_runtime15.jsx)(FocusedLineMark, {})]
      }), disableClipping ? null : (0, import_jsx_runtime15.jsx)(ChartsClipPath, {
        id: clipPathId,
        offset: clipPathOffset
      }), (0, import_jsx_runtime15.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), children]
    })), showTooltip && (0, import_jsx_runtime15.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
  });
});
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types13.default.bool,
   ...
   * @default 0
   */
  baseline: import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["max", "min"]), import_prop_types13.default.number]),
  /**
   * Configuration for the brush interaction.
   */
  brushConfig: import_prop_types13.default.shape({
    enabled: import_prop_types13.default.bool,
    preventHighlight: import_prop_types13.default.bool,
    preventTooltip: import_prop_types13.default.bool
  }),
   ...
   */
  clipAreaOffset: import_prop_types13.default.shape({
   ...
   */
  color: import_prop_types13.default.oneOfType([import_prop_types13.default.func, import_prop_types13.default.string]),
  /**
   * @default 'linear'
   */
  curve: import_prop_types13.default.oneOf(["bumpX", "bumpY", "catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types13.default.arrayOf(import_prop_types13.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default false
   */
  disableClipping: import_prop_types13.default.bool,
  /**
   * If true, the voronoi interaction are ignored.
   */
  disableVoronoi: import_prop_types13.default.bool,
  enableKeyboardNavigation: import_prop_types13.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * ```
   */
  hiddenItems: import_prop_types13.default.arrayOf(import_prop_types13.default.oneOfType([import_prop_types13.default.shape({
    ...
    type: import_prop_types13.default.oneOf(["bar"]).isRequired
  }), import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
    type: import_prop_types13.default.oneOf(["line"]).isRequired
  }), import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
    type: import_prop_types13.default.oneOf(["scatter"]).isRequired
  }), import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
    type: import_prop_types13.default.oneOf(["pie"]).isRequired
  }), import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
    type: import_prop_types13.default.oneOf(["radar"]).isRequired
  })]).isRequired),
  /**
   * The controlled axis highlight.
   * Identified by the axis id, and data index.
   */
  highlightedAxis: import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
   ...
   * ```
   */
  initialHiddenItems: import_prop_types13.default.arrayOf(import_prop_types13.default.oneOfType([import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]),
    type: import_prop_types13.default.oneOf(["bar"]).isRequired
  }), import_prop_types13.default.shape({
   ...
   * @param {VisibilityIdentifier[]} hiddenItems The new list of hidden identifiers.
   */
  onHiddenItemsChange: import_prop_types13.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   * @param {AxisItemIdentifier[]} axisItems The array of axes item identifiers.
   */
  onHighlightedAxisChange: import_prop_types13.default.func,
  /**
   ...
   * @param {SeriesItemIdentifier<TSeries> | null} tooltipItem  The newly highlighted item.
   */
  onTooltipItemChange: import_prop_types13.default.func,
  /**
   * Type of plot used.
   * @default 'line'
   */
  plotType: import_prop_types13.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types13.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types13.default.bool,
  /**
   * If `true`, animations are skipped.
   ...
   * Used when the tooltip is controlled.
   */
  tooltipItem: import_prop_types13.default.oneOfType([import_prop_types13.default.shape({
    dataIndex: import_prop_types13.default.number.isRequired,
    seriesId: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]).isRequired,
    type: import_prop_types13.default.oneOf(["bar"]).isRequired
  }), import_prop_types13.default.shape({
   ...
   */
  voronoiMaxRadius: import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["item"]), import_prop_types13.default.number]),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   */
  xAxis: import_prop_types13.default.oneOfType([import_prop_types13.default.shape({
    ...
    groups: import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
    ...
    ordinalTimeTicks: import_prop_types13.default.arrayOf(import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["biweekly", "days", "hours", "months", "quarterly", "weeks", "years"]), import_prop_types13.default.shape({
      format: import_prop_types13.default.func.isRequired,
      getTickNumber: import_prop_types13.default.func.isRequired,
      isTick: import_prop_types13.default.func.isRequired
    })]).isRequired),
    ...
    tickSize: import_prop_types13.default.number,
    tickSpacing: import_prop_types13.default.number,
    valueFormatter: import_prop_types13.default.func
  }), import_prop_types13.default.shape({
    axis: import_prop_types13.default.oneOf(["x"]),
    classes: import_prop_types13.default.object,
    ...
    constant: import_prop_types13.default.number,
    data: import_prop_types13.default.array,
    dataKey: import_prop_types13.default.string,
    disableLine: import_prop_types13.default.bool,
    disableTicks: import_prop_types13.default.bool,
    ...
    position: import_prop_types13.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types13.default.bool,
    scaleType: import_prop_types13.default.oneOf(["symlog"]),
    slotProps: import_prop_types13.default.object,
    slots: import_prop_types13.default.object,
    sx: import_prop_types13.default.oneOfType([import_prop_types13.default.arrayOf(import_prop_types13.default.oneOfType([import_prop_types13.default.func, import_prop_types13.default.object, import_prop_types13.default.bool])), import_prop_types13.default.func, import_prop_types13.default.object]),
    tickInterval: import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["auto"]), import_prop_types13.default.array, import_prop_types13.default.func]),
    ...
    label: import_prop_types13.default.string,
    labelStyle: import_prop_types13.default.object,
    max: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.shape({
      valueOf: import_prop_types13.default.func.isRequired
    })]),
    min: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.shape({
      valueOf: import_prop_types13.default.func.isRequired
    })]),
    offset: import_prop_types13.default.number,
    position: import_prop_types13.default.oneOf(["bottom", "none", "top"]),
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types13.default.oneOfType([import_prop_types13.default.shape({
